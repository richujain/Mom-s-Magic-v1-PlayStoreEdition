...
public class GroceryProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.pulimoottil.richu.momsmagic_indianfoodrecipe";
    ...
    static {
        sURLMatcher.addURI("com.pulimoottil.richu.momsmagic_indianfoodrecipe", "item", ITEMS);
        sURLMatcher.addURI("com.pulimoottil.richu.momsmagic_indianfoodrecipe", "item/#", ITEMS_ID);
    }
